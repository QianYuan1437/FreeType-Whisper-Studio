class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'pasteModeHint':
          'Incremental pastes only newly confirmed text. Whole transcript selects all and replaces the current field.',
    ...
    'zh': {
      ...
      'pasteWhole': '整段粘贴',
      'pasteModeHint': '增量粘贴只插入最新确认的文本；整段粘贴会先全选，再用完整转写覆盖当前输入框。',
